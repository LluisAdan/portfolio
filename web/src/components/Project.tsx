...
export default function Project() {
  ...
  return (
    <div id="projects" className="bg-slate-950 flex flex-col items-center py-20 px-4 md:px-10 border-t border-slate-800">
      ...
      <div className="flex flex-col space-y-16 mt-15 w-full max-w-6xl">
        {projects.map((project) => (
          <motion.div
            ...
            className="flex flex-col md:flex-row w-full space-x-0 md:space-x-4 mb-6 rounded-2xl p-4 md:p-5 bg-slate-900 border border-slate-800 shadow-xl shadow-black/20"
