  ...
  <div className="font-sans bg-slate-950 text-slate-100 min-h-screen">
    ...
    <main className="pt-18">
      <div className="relative p-10 md:p-20 lg:p-40 text-center flex flex-col items-center overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-[0.75] [background-image:linear-gradient(to_right,rgba(148,163,184,0.32)_1px,transparent_1px),linear-gradient(to_bottom,rgba(148,163,184,0.32)_1px,transparent_1px)] [background-size:48px_48px] [mask-image:radial-gradient(ellipse_at_center,black_42%,transparent_74%)]" />
